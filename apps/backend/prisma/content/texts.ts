...
export const HERO = {
  // Жёлтая мелкая надпись-эйбрау над заголовком убрана по замечанию
  // Заказчика от 19.08.2026 (п. 2) — дублировала название кластера.
  eyebrow: {
    ru: '',
    kk: '',
    en: '',
...
export const TASKS: TaskItem[] = [
  ...
  },
  {
    ...
    text: {
      // Формулировка заменена по замечанию Заказчика от 19.08.2026 (п. 4).
      ru: 'Создание условий для подготовки квалифицированных кадров в сфере туризма, гостеприимства, спорта, безопасности и горной индустрии.',
      kk: 'Туризм, қонақжайлылық, спорт, қауіпсіздік және тау индустриясы саласында білікті кадрлар даярлауға жағдай жасау.',
      en: 'Creating conditions for training qualified professionals in tourism, hospitality, sports, safety and the mountain industry.',
    },
  },
];
